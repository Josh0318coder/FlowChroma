        ...
        for seq_idx in range(batch_size):
            ...
            with autocast(enabled=args.use_amp):
                ...
                for i, (output_lab, gt_lab) in enumerate(zip(outputs, frames_lab)):
                    ...
                    # Contextual loss: style matching between pred and reference image
                    if i == 0:
...
def main():
    ...
    print("\n" + "="*80)
    print("Trainable Parameters Summary".center(80))
    print("="*80)
    ...
    for group in param_groups:
        ...
        name = group['name']
        print(f"{name:30s}: {num_params:>15,d} parameters")
